"""
macOS Chess Engines Configuration

Engine configuration module specifically for macOS (darwin platform).
Based on Linux configuration but adapted for macOS engine binaries and paths.

This module defines available chess engines, their executables, and
configuration parameters for the macOS version of Lucas Chess.

Part of macOS compatibility implementation.
"""
